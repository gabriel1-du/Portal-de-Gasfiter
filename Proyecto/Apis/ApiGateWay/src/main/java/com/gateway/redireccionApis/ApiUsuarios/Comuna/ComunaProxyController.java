package com.gateway.redireccionApis.ApiUsuarios.Comuna;
...
@RestController
@RequestMapping("/api/proxy/comunasApi")
@RequiredArgsConstructor
public class ComunaProxyController {

    private final RestTemplate restTemplate;
    private final JwtService jwtService;

    @Value("${services.comunas.base-url}")
    private String comunasBaseUrl;

    @Value("${services.comunas.base-path}")
